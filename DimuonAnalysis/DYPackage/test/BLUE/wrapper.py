...
#data vector 1
name_dv1 =  'ee_results_2014_abs_adhoc_Bayes.dat' 
#covariance matrix 1
...
length1 = '41'
#data vector 2
name_dv2 = 'mumu_results_2014_abs_Bayes.dat'
#covariance matrix 2
#covariance is always for rhsape for now
...
#analyzers
Popen('root -b -l -q \'resultCombiner_tester.C(\"'+name_dv1+'\",\"'+name_cm1+'\",\"'+length1+'\",\"'+name_dv2+'\",\"'+name_cm2+'\",\"'+length2+'\")\'',shell=True).wait()
